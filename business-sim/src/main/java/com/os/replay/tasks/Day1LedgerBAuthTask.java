...
public class Day1LedgerBAuthTask extends RecordReader implements Tasklet, StepExecutionListener {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		formData.add("username", "TestBorrower1User");
		formData.add("password", "FqnNQyUwaenQ8K3h");
	...
	public ExitStatus afterStep(StepExecution stepExecution) {
		...
		stepExecution.getJobExecution().getExecutionContext().put("ledgerBParty", "TBORR-US");
