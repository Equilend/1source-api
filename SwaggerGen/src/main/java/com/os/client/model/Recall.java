...
public class Recall implements Serializable{
  ...
  private Date recallDate = null;

  @SerializedName("recallDueDate")
  private Date recallDueDate = null;
  ...
  **/
  ...
  public Recall recallDate(Date recallDate) {
  ...
  **/
  ...
  public Recall recallDueDate(Date recallDueDate) {
  ...
  **/
  @Schema(description = "")
  public Date getRecallDueDate() {
    return recallDueDate;
  }

  public void setRecallDueDate(Date recallDueDate) {
    this.recallDueDate = recallDueDate;
  }

  public Recall lastUpdateDatetime(Date lastUpdateDatetime) {
