...
public class ReratesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerReratesGetCall(Date since, Date before, Integer size, RerateStatus rerateStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call ledgerReratesGetValidateBeforeCall(Date since, Date before, Integer size, RerateStatus rerateStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Rerates ledgerReratesGet(Date since, Date before, Integer size, RerateStatus rerateStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Rerates> ledgerReratesGetWithHttpInfo(Date since, Date before, Integer size, RerateStatus rerateStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerReratesGetAsync(Date since, Date before, Integer size, RerateStatus rerateStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, final ApiCallback<Rerates> callback) throws ApiException {
