package com.os.tester.util;

import com.onesource.demo.dto.LedgerResponseDTO;
import com.os.tester.auth.Authentication;
import com.os.tester.auth.OAuth;
...
public class ApiHelper {
    ...
    public ApiHelper() {
        ...
        restTemplate.getInterceptors().add(new com.onesource.demo.util.RequestLoggingInterceptor());
    }
