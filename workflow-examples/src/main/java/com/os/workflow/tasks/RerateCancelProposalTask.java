...
public class RerateCancelProposalTask implements Tasklet, StepExecutionListener {
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		LedgerResponse ledgerResponse = restWebClient.post().uri("/loans/" + workflowConfig.getLoan_id() + "/rerates/" + workflowConfig.getRerate_id() + "/cancel").contentType(MediaType.APPLICATION_JSON)
				//.bodyValue(json)
