...
public class ApproveContractTask implements Runnable {
	...
	private static final Logger logger = LoggerFactory.getLogger(ApproveContractTask.class);

	private WebClient webClient;
	private String contractId;
	private ContractProposalApproval contractProposalApproval;

	public ApproveContractTask(WebClient webClient, String contractId, ContractProposalApproval contractProposalApproval) {
	...
	public void run() {
		...
		try {
			LedgerResponse ledgerResponse = webClient.post()
					.uri("/contracts/" + contractId + "/approve")
