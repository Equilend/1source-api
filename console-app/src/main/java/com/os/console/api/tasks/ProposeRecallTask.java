...
public class ProposeRecallTask implements Runnable {
	...
	public ProposeRecallTask(WebClient webClient, String contractId, RecallProposal recallProposal) {
	...
	public void run() {
		...
		LedgerResponse ledgerResponse = webClient.post().uri("/contracts/" + contractId + "/recalls")
